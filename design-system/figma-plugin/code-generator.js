 ...
 */
function createBottomNav(archetype = 'Mail', count = 12) {
...
function generateAdsEmailPage() {
    ...
    adsCard.fills = createGradient(TOKENS.colors.gradients.ads.start, TOKENS.colors.gradients.ads.end);
    adsCard.effects = [{
            type: 'DROP_SHADOW',
...
function generateWorkEmailPage() {
    ...
    workCard.fills = createGradient(TOKENS.colors.gradients.mail.start, TOKENS.colors.gradients.mail.end);
    workCard.effects = [{
            type: 'DROP_SHADOW',
            color: { r: 0, g: 0, b: 0, a: 0.4 },
            offset: { x: 0, y: 10 },
...
function generateEmailCards() {
    ...
    mailCard.fills = createGradient(TOKENS.colors.gradients.mail.start, TOKENS.colors.gradients.mail.end);
...
function generateActionSelectorPage() {
    ...
    bottomSheet.fills = createGradient(TOKENS.colors.gradients.mail.start, TOKENS.colors.gradients.mail.end);
 ...
 */
function createBrowserScreen(phone, actionName) {
 ...
 */
function createCalendarModal(phone, actionName) {
    const screen = figma.createFrame();
 ...
 */
function createShareSheet(phone, actionName) {
    const screen = figma.createFrame();
 ...
 */
function createMessageComposer(phone, actionName) {
    const screen = figma.createFrame();
 ...
 */
function getScreenForAction(phone, action) {
 ...
 */
function createActionCard(action, width, height) {
    ...
    // Gradient background
    const gradientKey = action.gradient;
