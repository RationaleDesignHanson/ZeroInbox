 ...
 */
async function createModalHeader() {
 ...
 */
async function createModalContextHeader() {
    const component = figma.createComponent();
 ...
 */
async function createFormTextInputVariants() {
    const states = [
 ...
 */
async function createFormTextArea() {
    const component = figma.createComponent();
 ...
 */
async function createFormDropdown() {
    const component = figma.createComponent();
 ...
 */
async function createFormDatePicker() {
    const component = figma.createComponent();
 ...
 */
async function createButtonPrimaryGradient() {
    const component = figma.createComponent();
 ...
 */
async function createButtonSecondaryGlass() {
    const component = figma.createComponent();
 ...
 */
async function createButtonDestructive() {
    const component = figma.createComponent();
 ...
 */
async function createStatusBannerVariants() {
    const types = [
...
function createLoadingSpinner() {
    ...
    spinner.strokes = [{
            ...
            gradientStops: [
                { position: 0, color: Object.assign(Object.assign({}, COLORS.blue), { a: 1 }) },
                { position: 0.5, color: Object.assign(Object.assign({}, COLORS.blue), { a: 0.5 }) },
                { position: 1, color: Object.assign(Object.assign({}, COLORS.blue), { a: 0 }) }
            ]
        }];
 ...
 */
async function createDetailRow() {
    const component = figma.createComponent();
...
async function generateModalComponents() {
    try {
        ...
        let modalComponentsPage = figma.root.children.find(page => page.name === 'Modal Components');
