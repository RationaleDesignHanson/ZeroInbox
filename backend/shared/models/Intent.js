...
const IntentTaxonomy = {
  ...
  'billing.invoice.due': {
    ...
    negativePatterns: ['paid', 'payment received', 'thank you for', 'receipt'],
  ...
  'healthcare.appointment.reminder': {
    ...
    negativePatterns: ['cancelled', 'canceled', 'rescheduled', 'no longer needed', 'confirmed', 'confirmation', 'scheduled for', 'booking confirmed'],
  ...
  'healthcare.appointment.booking_request': {
    ...
    negativePatterns: ['confirmed', 'confirmation', 'scheduled for', 'appointment with', 'appointment on', 'see you on'],
    requiredEntities: [],
